...
function write_cache($filename, $data) {
    ...
    public function ruleDeleted($rid) {
        ...
        @unlink(IA_ROOT .  "/addons/ewei_comeon/data/" . $rid . ".txt");
        @unlink(IA_ROOT .  "/addons/ewei_comeon/data/" . $rid . "_rules.txt");
        @unlink(IA_ROOT .  "/addons/ewei_comeon/data/" . $rid . "_awards.txt");
