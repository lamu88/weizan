			...
			<div class="media">
				<div class="pull-right" style="width:230px;">
					<div class="module-set">
						...
						<a href="http://addons.012wz.com/web/index.php?c=store&a=author&do=application&id={{m.id}}" target="_blank">查看详情</a>
						&nbsp;
					</div>
				</div>
				<img class="media-object img-rounded gray" ng-src="http://addons.012wz.com/resource/attachment/{{m.thumb}}" onerror="this.src='../web/resource/images/nopic-small.jpg'">
				<div class="media-body">
					<h4 class="media-heading">
