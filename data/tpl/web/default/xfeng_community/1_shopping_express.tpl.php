...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'display') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('shopping',array('op' =>'express','operation' => 'display'))?>">物流方式</a></li>
	<li<?php  if($operation == 'post' && empty($express['id'])) { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('shopping',array('op' =>'express','operation' => 'post'))?>">添加物流方式</a></li>
	<?php  if(!empty($express['id']) && $operation== 'post') { ?> <li class="active"><a href="<?php  echo $this->createWebUrl('shopping',array('op' =>'express','operation' => 'post','id'=>$express['id']))?>">编辑物流方式</a></li> <?php  } ?>
</ul>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:left;">
						<a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'express','operation' => 'post', 'id' => $item['id']))?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="修改"><i class="fa fa-pencil"></i></a>
						<a href="<?php  echo $this->createWebUrl('express', array('op' => 'express', 'operation' => 'delete','id' => $item['id']))?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="删除"><i class="fa fa-times"></i></a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
