...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'goods','operation' =>'post'))?>">添加商品</a></li>
	<li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'goods','operation' => 'display'))?>">管理商品</a></li>
</ul>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="tab-content">
					<div class="tab-pane  active" id="tab_basic"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('shopping_goods_basic', TEMPLATE_INCLUDEPATH)) : (include template('shopping_goods_basic', TEMPLATE_INCLUDEPATH));?></div>
					<div class="tab-pane" id="tab_des"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('shopping_goods_des', TEMPLATE_INCLUDEPATH)) : (include template('shopping_goods_des', TEMPLATE_INCLUDEPATH));?></div>
					<div class="tab-pane" id="tab_param"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('shopping_goods_param', TEMPLATE_INCLUDEPATH)) : (include template('shopping_goods_param', TEMPLATE_INCLUDEPATH));?></div>
					<div class="tab-pane" id="tab_option"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('shopping_goods_option', TEMPLATE_INCLUDEPATH)) : (include template('shopping_goods_option', TEMPLATE_INCLUDEPATH));?></div>
					<div class="tab-pane" id="tab_other"><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('shopping_goods_other', TEMPLATE_INCLUDEPATH)) : (include template('shopping_goods_other', TEMPLATE_INCLUDEPATH));?></div>
				</div>
			</div>
		</div>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:right;">
						<a href="<?php  echo $this->createWebUrl('shopping', array('id' => $item['id'], 'op' => 'goods','operation' => 'post'))?>"class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="编辑"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;
						<a href="<?php  echo $this->createWebUrl('shopping', array('id' => $item['id'], 'op' => 'goods','operation' => 'delete'))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="删除"><i class="fa fa-times"></i></a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
