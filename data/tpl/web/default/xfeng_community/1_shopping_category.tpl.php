...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'post') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'category','operation' => 'post'))?>">添加分类</a></li>
	<li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'category','operation' => 'display'))?>">管理分类</a></li>
</ul>
<script>
				...
				<div class="panel-body table-responsive">
					<table class="table table-hover">
						...
						<tr>
							...
							<td>
								...
								<div class="type-parent"><?php  echo $row['name'];?>
									...
									<a href="<?php  echo $this->createWebUrl('shopping', array('parentid' => $row['id'], 'op' => 'category','operation' => 'post'))?>"><i class="fa fa-plus-circle"></i> 添加子分类</a><?php  } ?>
								</div>
							</td>
							<td>
							...
							<td>
								<a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'category', 'operation' => 'post', 'id' => $row['id']))?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="编辑"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
								<a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'category','operation' => 'delete', 'id' => $row['id']))?>" onclick="return confirm('确认删除此分类吗？');return false;" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="删除"><i class="fa fa-times"></i></a>
							</td>
						</tr>
						...
						<tr>
							<td></td>
							<td colspan="4">
								<a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'category','operation' => 'post'))?>"><i class="fa fa-plus-sign-alt"></i> 添加新分类</a>
							</td>
						</tr>
						<tr>
							<td></td>
