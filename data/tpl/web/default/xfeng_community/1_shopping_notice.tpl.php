...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'display') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('shopping', array('operation' => 'display','op' => 'notice'))?>">管理</a></li>
</ul>
			...
			<table class="table table-hover">
				...
				<tr>
					...
					<td style="text-align:right;">
						<a href="<?php  echo $this->createWebUrl('shopping', array('id' => $item['order']['id'], 'operation' => 'detail','op' => 'order'))?>">订单详情</a>
						&nbsp;&nbsp;
						<a href="<?php  echo $this->createWebUrl('shopping', array('id' => $item['id'], 'operation' => 'delete','op' => 'notice'))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;">删除</a>
					</td>
				</tr>
				<?php  } } ?>
				</tbody>
