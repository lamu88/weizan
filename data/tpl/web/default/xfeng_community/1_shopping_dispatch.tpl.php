...
<ul class="nav nav-tabs">
	<li <?php  if($operation == 'display') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('shopping',array('op' =>'dispatch','operation' => 'display'))?>">配送方式</a></li>
	<li<?php  if(empty($dispatch['id']) && $operation == 'post') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('shopping',array('op' =>'dispatch','operation' => 'post'))?>">添加配送方式</a></li>
	<?php  if(!empty($dispatch['id']) && $operation== 'post') { ?> <li class="active"><a href="<?php  echo $this->createWebUrl('shopping',array('op' =>'dispatch','operation' => 'post','id'=>$dispatch['id']))?>">编辑配送方式</a></li> <?php  } ?>
</ul>
