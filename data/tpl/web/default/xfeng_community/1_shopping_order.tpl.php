...
<ul class="nav nav-tabs">
	...
	<a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'order','operation' => 'display'))?>">全部订单</a></li>
	<li <?php  if($operation == 'display' && $status == '1' && ( $sendtype=='1' || $sendtype=='0')) { ?> class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'order','operation' => 'display', 'status' => 1))?>">待发货</a></li>
	<li <?php  if($operation == 'display' && $status == '1' && $sendtype == '2') { ?>class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'order','operation' => 'display', 'status' => '1', 'sendtype' => 2))?>">待自提</a></li>
	<li <?php  if($operation == 'display' && $status == '0') { ?>class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'order', 'operation' => 'display','status' => 0))?>">待付款</a></li>
	<li <?php  if($operation == 'display' && $status == '2') { ?>class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'order', 'operation' => 'display','status' => 2))?>">待收货</a></li>
	<li <?php  if($operation == 'display' && $status == '3') { ?>class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'order', 'operation' => 'display','status' => 3))?>">已完成</a></li>
	<li <?php  if($operation == 'display' && $status == '-1') { ?>class="active"<?php  } ?>>
	<a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'order','operation' => 'display', 'status' => -1))?>">已关闭</a></li>
...
<div class="panel panel-info">
	...
	<div class="panel-body">
		<form action="./index.php" method="get" class="form-horizontal" role="form" id="form1">
			...
			<div class="form-group">
					...
					<div class="col-sm-3 col-lg-4 pull-right"><button class="btn btn-default"><i class="fa fa-search"></i> 搜索</button></div>
				</div>
			<div class="form-group">
			</div>
		</form>
	...
	<!--					<td><?php  if($item['goodstype']) { ?>实物<?php  } else { ?>虚拟<?php  } ?></td>-->
						...
						<td style="text-align:right;">
							...
							<a href="<?php  echo $this->createWebUrl('shopping', array('op' => 'order','id' => $item['id'], 'operation' => 'delete'))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;" 
			...
			<div class="panel-body table-responsive">
				<table class="table table-hover">
					...
					<tr>
						...
						<td>
							<a href="<?php  echo $this->createWebUrl('shopping', array('id' => $goods['id'],'op' => 'goods', 'operation' => 'post'))?>" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="编辑"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
							<a href="<?php  echo $this->createWebUrl('shopping', array('id' => $id, 'op' => 'order','operation' => 'delete'))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="bottom" title="删除"><i class="fa fa-times"></i></a>
						</td>
					</tr>
					<?php  } } ?>
					<tr>
